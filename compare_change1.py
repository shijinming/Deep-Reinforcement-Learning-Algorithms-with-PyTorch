...
task_num = 32
task_file = "../sac/change_tasks1.txt"
# environment = VEC_Environment(num_vehicles=50, task_num=task_num)
...
for iter in range(200):
    ...
    for task_num in range(8,65,8):
        ...
        environment.load_offloading_tasks(task_file, task_num//8 + 8*(iter%10))
